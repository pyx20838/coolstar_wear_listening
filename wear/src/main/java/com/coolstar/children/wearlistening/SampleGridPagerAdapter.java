...
public class SampleGridPagerAdapter extends FragmentGridPagerAdapter {
    ...
    public SampleGridPagerAdapter(Context ctx, FragmentManager fm,int gradenum,TextToSpeech tts) {
        super(fm);
        mContext = ctx;
        mGradenum = gradenum;
        mtts = tts;
    ...
    public Fragment getFragment(int row, int col) {
        ...
        //click
//        final String ttsspeak = title + text;
//        fragment.getView().setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                mtts.speak(ttsspeak,TextToSpeech.QUEUE_FLUSH,null);
//            }
//        });
